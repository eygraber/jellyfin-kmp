  ...
  fun singleForbiddenMaterialIcons() {
    runTest(
      code = """
          ...
          """,
      expectedOutput = """
        src/test.kt:5: Error: Usage of Icons from material-icons-core is not supported in Jellyfin. Use JellyfinIcons instead. [ForbiddenMaterialIcons]
          Icons
          ~~~~~
  ...
  fun singleForbiddenMaterialIconsParameter() {
    runTest(
      code = """
          ...
          """,
      expectedOutput = """
        src/test.kt:4: Error: Usage of Icons from material-icons-core is not supported in Jellyfin. Use JellyfinIcons instead. [ForbiddenMaterialIcons]
        fun test(icons: Icons) {}
                 ~~~~~~~~~~~~
        src/test.kt:5: Error: Usage of Icons from material-icons-core is not supported in Jellyfin. Use JellyfinIcons instead. [ForbiddenMaterialIcons]
        fun test(icons: Icons.Defaults) {}
