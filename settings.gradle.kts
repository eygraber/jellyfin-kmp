...
include(":apps:web")
include(":common")
include(":data:admin:fake")
include(":data:admin:impl")
include(":data:admin:public")
include(":data:auth:impl")
include(":data:auth:public")
include(":data:items:impl")
include(":data:items:public")
include(":data:live-tv:impl")
include(":data:live-tv:public")
include(":data:playback:impl")
include(":data:playback:public")
include(":data:search:impl")
include(":data:search:public")
include(":data:search-history:impl")
include(":data:search-history:public")
...
include(":konsist")
include(":nav")
include(":screens:collection-items")
include(":screens:episode-detail")
include(":screens:genre-items")
include(":screens:home")
include(":screens:login")
include(":screens:library-collections")
include(":screens:library-genres")
include(":screens:library-movies")
include(":screens:movie-detail")
...
include(":services:player:impl")
include(":services:player:public")
