...
@Composable
fun JellyfinPreviewTheme(
  isDarkMode: Boolean = isSystemInDarkTheme(),
  content: @Composable () -> Unit,
) {
  JellyfinTheme(isDarkMode = isDarkMode) {
...
@Composable
fun JellyfinModalBottomSheetPreviewTheme(
  isDarkMode: Boolean = isSystemInDarkTheme(),
...
@Composable
expect fun JellyfinEdgeToEdgePreviewTheme(
  isDarkMode: Boolean = isSystemInDarkTheme(),
  content: @Composable () -> Unit,
)
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun JellyfinEdgeToEdgeModalBottomSheetPreviewTheme(
  isDarkMode: Boolean = isSystemInDarkTheme(),
  skipPartiallyExpanded: Boolean = false,
  initialValue: SheetValue = SheetValue.PartiallyExpanded,
  properties: ModalBottomSheetProperties = ModalBottomSheetProperties(),
