...
val JellyfinIcons.Search: ImageVector
  get() {
    if(internalSearch != null) {
      return requireNotNull(internalSearch)
    }
    internalSearch = materialIcon(name = "Filled.Search") {
      materialPath {
        moveTo(15.5f, 14.0f)
...
private var internalSearch: ImageVector? = null
