      ...
      Box(
        ...
        Column(
          ...
          WithMaxDensity(maxFontScale = 1.5F) {
            ...
            Text(
              text = stringResource(R.string.onboarding_splash_body),
              textAlign = TextAlign.Center,
              modifier = Modifier
                .padding(24.dp),
            ...
            Button(
              ...
              Text(stringResource(R.string.onboarding_splash_sign_up))
            }
            ...
            Text(
              text = stringResource(R.string.onboarding_splash_privacy_tos),
              textAlign = TextAlign.Center,
