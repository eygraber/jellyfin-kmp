...
interface AndroidAppModule {
  ...
  @get:Provides @AppContext val context: Context get() = application.applicationContext

  @Provides fun assetManager(): AssetManager = context.assets
  @Provides fun contentResolver(): ContentResolver = context.contentResolver
  @Provides fun mainLooper(): Looper = context.mainLooper
  @Provides fun packageManager(): PackageManager = context.packageManager
  @Provides fun resources(): Resources = context.resources
  @Provides fun sharedPreferences(@Assisted name: String): SharedPreferences =
  ...
  @Provides fun inputMethodManager(): InputMethodManager =
  ...
  @Provides fun mediaSessionManager(): MediaSessionManager =
    context.getSystemService(MediaSessionManager::class.java)

  @Provides fun networkStatsManager(): NetworkStatsManager =
  ...
  @Provides fun notificationManager(): NotificationManager =
  ...
  @Provides fun restrictionsManager(): RestrictionsManager =
  ...
  @Provides fun subscriptionManager(): SubscriptionManager =
    context.getSystemService(SubscriptionManager::class.java)

  @Provides fun systemHealthManager(): SystemHealthManager =
  ...
  @Provides fun textServicesManager(): TextServicesManager =
